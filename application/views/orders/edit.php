                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td><input type="text" name="qty[]" id="qty_<?php echo $x; ?>" class="form-control" required onkeyup="getTotal(<?php echo $x; ?>)" value="<?php echo $val['order_qty'] ?>" autocomplete="off"></td>
                          <td>
