                       ...
                       <td>
                        <select class="form-control select_group product" data-row-id="row_1" id="product_1" name="product[]" style="width:100%;" onchange="getProductData(1)" required>
                            ...
                            <?php foreach ($products as $k => $v): ?>
                              <option value="<?php echo $v['id'] ?>"><?php echo $v['name']." ". $v['variation_name'] ?></option>
                            <?php endforeach ?>
                          </select>
                        </td>
                        <td><input type="number" name="qty[]" id="qty_1" class="form-control" min="1" max="" required oninput="getTotal(1)"></td>
                        <td>
...
<script type="text/javascript">
  ...
  function getTotal(row = null) {
    ...
    var value =$("#qty_"+row).val();
    //alert(value);

    $.ajax({
      method:"post",
      url:base_url + '/orders/checkqty/',
      data:{current_qty:value},
    ...
    if(product_id == "") {
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          $("#qty_"+row_id).attr({"max" : response.qty});
          //$("#qty_1"+row_id").attr("max","+current_qty");
