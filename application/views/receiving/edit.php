          ...
          <form role="form" action="<?php base_url('receiving/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="invoice_no" name="invoice_no" placeholder="Invoice No" autocomplete="off" value="<?php echo $receiving_data['receiving']['invoice_no'] ?>">
                    </div>
                  </div>
                </div>
                      ...
                      <?php //var_dump($val);?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td>
                          <?php //var_dump($v);?>
                          <input type="text" name="qty[]" id="qty_<?php echo $x; ?>" class="form-control"  value="<?php echo $val['supplies_qty'] ?>" autocomplete="off"></td>
