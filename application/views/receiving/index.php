    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createSupplier', $user_permission)): ?>
          <a href="<?php echo base_url('receiving/create') ?>" class="btn btn-primary">Add Supply</a>
          <br /> <br />
        <?php endif; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('receiving/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'receiving/fetchReceivingData',
    'order': []
  });
