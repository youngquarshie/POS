...
class Model_orders extends CI_Model
{
	...
	public function getOrdersData($id = null)
	{
		...
		if($id) {
			$sql = "SELECT * FROM orders INNER JOIN users ON orders.user_id = users.id WHERE orders.user_id= ? AND orders.id = ?";
			$query = $this->db->query($sql, array($user_id, $id));
			return $query->row_array();
		}

		$sql = "SELECT * FROM orders INNER JOIN users ON orders.user_id = users.id WHERE orders.user_id= ? ORDER BY orders.user_id DESC";
